...
--
-- vim.api.nvim_set_hl(0, "ColorColumn",{ bg = colors.white })
-- vim.api.nvim_set_hl(0, "CursorColumn",{ bg = colors.white })
-- vim.api.nvim_set_hl(0, "CursorLine",{ bg = colors.white })
...
--
-- vim.api.nvim_set_hl(0, "netrwDir",{ fg = colors.bright_cyan })
-- vim.api.nvim_set_hl(0, "netrwExe",{ fg = colors.bright_red })
-- vim.api.nvim_set_hl(0, "netrwSymlink",{ fg = colors.brihgt_green })
